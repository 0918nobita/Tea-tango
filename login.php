...
<html lang="ja">
<head>
<title><?php echo lang('login').'┃Tea-tango'; ?></title>
<meta charset="UTF-8">
</head>
<body>
<div id="main">
<div id="page-title">
<div id="page-title-text"><p><?php echo lang('login') ?></p></div>
</div>
<form action="" method="POST">
<p><?php echo lang('email_address') ?>：<input type="text" name="email" value="<?php echo h($email); ?>"> <?php echo h($err['email']); ?></p>
<p><?php echo lang('password') ?>：<input type="password" name="password" value=""> <?php echo h($err['password']); ?></p>
<input type="hidden" name="token" value="<?php echo h($_SESSION['token']); ?>">
<p><?php echo '<input type="submit" value="'.lang('login').'">　<a href="signup.php?lang='.$_SESSION['lang'].'">'.lang('create_account').'</a></p>'; ?>
</form>
