...
<div class="main">
	<h2>Tea-tangoとは</h2>
	<p>　Tea-tango(旧「英単語テスト」)は、簡単に英単語を暗記できる「英単語暗記支援サイト」です。Cookieを利用してユーザーのデータを端末に蓄積しスコアを管理することで、自分にとって暗記できていない単語を発見したり、暗記できていない単語のみで小テストをすることができるようになります。<br /><br />　Tea-tangoの利用は無料です。</p>
